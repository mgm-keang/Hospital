            ...
            document.getElementById('image').addEventListener('change', function(e) {
                ...
                if (file) {
                    ...
                    reader.onload = function(evt) {
                        ...
                        if (current) {
                            current.style.display = 'none'; // hide old image when new selected
                        }
                    };
    ...
    @section('mainContent')
        ...
        <div class="registration-container">
            <div class="form-container">
                ...
                @endif
                <form id="registrationForm" enctype="multipart/form-data" action="{{ route('doctors.update', $doctor->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select id="gender" name="gender" required>
                                <option>{{ old('gender', $doctor->gender) }}</option>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea id="address" name="address" required placeholder="Enter your full address">{{ old('address', $doctor->address) }}</textarea>
                        </div>
                            ...
                            <select id="status_id" name="status_id" required>
                                @foreach ($statuses as $status)
                                    <option value="{{ $status->id }}"
                                        {{ old('status_id', $doctor->status_id ?? '') == $status->id ? 'selected' : '' }}>
                                        {{ $status->status_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group full-width">
                            ...
                            <!-- File input (hidden, triggered by upload box) -->
                                ...
                                <div class="image-upload-content">
                                    ...
                                    @if (!empty($doctor->image))
                                        <div style="margin-top: 1rem;">
                                            <img id="current-image" src="{{ asset('storage/' . $doctor->image) }}"
                                                alt="Current Doctor Profile Image"
                                    ...
                                    <div style="margin-top: 1rem;">
                                        <img id="preview-image" src="#" alt="New Image Preview"
                                            style="display: none; max-width: 150px; border: 1px dashed #ccc; padding: 4px;">
                                    </div>
