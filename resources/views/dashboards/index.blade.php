...
<head>
    ...
    <!-- Main CSS File -->
    <link href="{{ URL::asset('Css/Main-dashboad.css') }}" rel="stylesheet">
...
<body class="index-page">
    ...
    <header id="header" class="header sticky-top">
            ...
            <div class="container d-flex justify-content-center justify-content-md-between">
                <div class="contact-info d-flex align-items-center">
                    <i class="bi bi-envelope d-flex align-items-center"><a
                            href="keang3301@gmail.com">Keang3301@gamil.com</a></i>
                    <i class="bi bi-phone d-flex align-items-center ms-4"><span>+855 873 106 09</span></i>
                </div>
                <div class="social-links d-none d-md-flex align-items-center">
                    <a href="https://x.com/NYCHealthSystem" class="twitter"><i class="bi bi-twitter-x"></i></a>
                    <a href="https://www.facebook.com/share/g/16oJWQZ1Ax/" class="facebook"><i
                            class="bi bi-facebook"></i></a>
                    <a href="https://www.instagram.com/hospitaldeamor" class="instagram"><i
                            class="bi bi-instagram"></i></a>
                    <a href="https://www.linkedin.com/posts/duke-university_meet-andy-kavul-a-communications-fellow-activity-7354521968546623489-2EOZ"
        ...
        <div class="branding d-flex align-items-center">
            ...
            <div class="container position-relative d-flex align-items-center justify-content-between">
                ...
                <a class="cta-btn d-none d-sm-block" href="{{route('doctors.index')}}">Login</a>
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section light-background">
            ...
            <img src="{{ URL::asset('images/hero-bg.jpg') }}" alt="" data-aos="fade-in">
            ...
            <div class="container">
                ...
                <div class="row gy-4 gx-5">
                    ...
                    <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="200">
                        <img src="{{ URL::asset('images/about.jpg') }}" class="img-fluid" alt="">
                        <a href="https://youtu.be/wQ2TN_gI3sE?si=myu-c1aMU-o3QzEU"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active show" id="departments-tab-1">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ URL::asset('images/departments-1.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="departments-tab-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ URL::asset('images/departments-2.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="departments-tab-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ URL::asset('images/departments-3.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="departments-tab-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ URL::asset('images/departments-4.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="departments-tab-5">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ URL::asset('images/departments-5.jpg') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    @foreach ($doctors as $doctor)
                        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                            <div class="team-member d-flex align-items-start">
                                <div class="pic">
                                    <img src="{{ $doctor->image ? asset('storage/' . $doctor->image) : asset('images/doctos/default.jpg') }}"
                                        class="img-fluid" alt="Doctor Image">
                                </div>
                                <div class="member-info">
                                    <h4>{{ $doctor->name }}</h4>
                                    <span>{{ $doctor->status->status_name ?? 'Unknown Role' }}</span>
                                    <p>{{ $doctor->address }}</p>
                                    <div class="social">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="d-flex">
                                            <img src="{{ URL::asset('images/testimonials/testimonials-1.jpg') }}"
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="d-flex">
                                            <img src="{{ URL::asset('images/testimonials/testimonials-2.jpg') }}"
                                                class="testimonial-img flex-shrink-0" alt="">
                                            <div>
                                                <h3>Sara Wilsson</h3>
                                                <h4>Designer</h4>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="d-flex">
                                            <img src="{{ URL::asset('images/testimonials/testimonials-3.jpg') }}"
                                                class="testimonial-img flex-shrink-0" alt="">
                                            <div>
                                                <h3>Jena Karlis</h3>
                                                <h4>Store Owner</h4>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="d-flex">
                                            <img src="{{ URL::asset('images/testimonials/testimonials-4.jpg') }}"
                                                class="testimonial-img flex-shrink-0" alt="">
                                            <div>
                                                <h3>Matt Brandon</h3>
                                                <h4>Freelancer</h4>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="d-flex">
                                            <img src="{{ URL::asset('images/testimonials/testimonials-5.jpg') }}"
                                                class="testimonial-img flex-shrink-0" alt="">
                                            <div>
                                                <h3>John Larson</h3>
                                                <h4>Entrepreneur</h4>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ URL::asset('images/gallery/gallery-1.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ URL::asset('images/gallery/gallery-1.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ URL::asset('images/gallery/gallery-2.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ URL::asset('images/gallery/gallery-2.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ URL::asset('images/gallery/gallery-3.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ URL::asset('images/gallery/gallery-3.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ URL::asset('images/gallery/gallery-4.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ URL::asset('images/gallery/gallery-4.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ URL::asset('images/gallery/gallery-5.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ URL::asset('images/gallery/gallery-5.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ URL::asset('images/gallery/gallery-6.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ URL::asset('images/gallery/gallery-6.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ URL::asset('images/gallery/gallery-7.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ URL::asset('images/gallery/gallery-7.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ URL::asset('images/gallery/gallery-8.jpg') }}" class="glightbox"
                                data-gallery="images-gallery">
                                <img src="{{ URL::asset('images/gallery/gallery-8.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div><!-- End Gallery Item -->
        ...
        <section id="contact" class="contact section">
            ...
            <div class="mb-5" data-aos="fade-up" data-aos-delay="200">
                <iframe style="border:0; width: 100%; height: 270px;"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3908.854284393885!2d104.87818801034425!3d11.562301988590905!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x310951a354c389d9%3A0xd07843ea8349e8c1!2z4Z6Y4Z6T4Z-S4Z6R4Z644Z6a4Z6W4Z-B4Z6R4Z-S4Z6Z4Z6a4Z-J4Z684Z6Z4Z-J4Z624Z6b4Z-L4Z6X4Z-S4Z6T4Z-G4Z6W4Z-B4Z6J!5e0!3m2!1skm!2skh!4v1753685448281!5m2!1skm!2skh"
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4">
                        <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div>
                                <h3>Location</h3>
                                <p>Royal Phnom Penh Hospital, 888 មហាវិថី សហពន្ធ័រុស្ស៊ី (១១០), ភ្នំពេញ</p>
                            </div>
                        </div><!-- End Info Item -->
            ...
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6 footer-about">
                    ...
                    <div class="footer-contact pt-3">
                        ...
                        <p>Khmer, NY 535022</p>
                        <p class="mt-3"><strong>Phone:</strong> <span>+885 873 106 09</span></p>
                        <p><strong>Email:</strong> <span>Megamindh1r@gamil.com</span></p>
                    </div>
                    <div class="social-links d-flex mt-4">
                        <a href="https://x.com/NYCHealthSystem"><i class="bi bi-twitter-x"></i></a>
                        <a href="https://www.facebook.com/share/g/16oJWQZ1Ax/"><i class="bi bi-facebook"></i></a>
                        <a href="https://www.instagram.com/hospitaldeamor"><i class="bi bi-instagram"></i></a>
                        <a
                            href="https://www.linkedin.com/posts/duke-university_meet-andy-kavul-a-communications-fellow-activity-7354521968546623489-2EOZhttps://www.linkedin.com/posts/duke-university_meet-andy-kavul-a-communications-fellow-activity-7354521968546623489-2EOZ"><i
    ...
    <!-- Main JS File -->
    <script src="{{ URL::asset('JS/main-dashboad.js') }}"></script>
